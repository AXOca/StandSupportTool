...
namespace StandSupportTool
{
    public partial class MainWindow : Window
    {
        ...
        // Event handlers for help text display
        private void Button_MouseEnter(object sender, RoutedEventArgs e)
        {
            if (sender is Button button)
            {
                HelpTextBlock.Text = button.ToolTip.ToString();
        ...
        private void ComboBox_MouseEnter(object sender, RoutedEventArgs e)
        {
            ...
            {
                HelpTextBlock.Text = "Select a protocol from the dropdown.";
                HelpTextBlock.Visibility = Visibility.Visible;
            }
        }

        private void ComboBox_MouseLeave(object sender, RoutedEventArgs e)
        {
            HelpTextBlock.Visibility = Visibility.Collapsed;
        }
        ...
        private void TextBox_MouseEnter(object sender, RoutedEventArgs e)
        {
            ...
            {
                HelpTextBlock.Text = "Displays the current activation key.";
                HelpTextBlock.Visibility = Visibility.Visible;
            }
        }
